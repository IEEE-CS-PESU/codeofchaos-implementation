...
# If the day is friday then set the battery threshold to 100
# If the day is sunday then set the battery threshold to 61
#if [[ $day = 5 ]]
#then
#	sudo bat --threshold 100 && sudo bat --persist
#elif [[ $day = 7  ]]
#	sudo bat --threshold 61 && sudo bat --persist
#fi
