# this program has only one error. It won't be easy for participants that have no idea about socket programming
# successful execution is sufficient

from socket import *
import os
ip_addr="8.8.8.8" # the participants have to use ifconfig to get this right
port_num=4497
port_num_conn=4603
USERNAME_REQ="admin"
PASSWORD_REQ="admin"
